...
export default function MainLayout({ children }: MainLayoutProps) {
  ...
  const navigation = [
    ...
    { name: 'Magazyn', href: '/inventory', icon: 'cube' },
    { name: 'Zamówienia', href: '/orders', icon: 'shopping-cart' },
    { name: 'Produkcja', href: '/production', icon: 'clipboard' },
    { name: 'Ustawienia', href: '/settings', icon: 'cog' },
  ];
      ...
      <div className="md:pl-64 flex flex-col flex-1">
        ...
        <header className="bg-white shadow">
          <div className="max-w-7xl mx-auto py-4 px-4 sm:px-6 lg:px-8 flex justify-between items-center">
            <h1 className="text-lg font-semibold text-gray-900">Chmurowy System MRP</h1>
