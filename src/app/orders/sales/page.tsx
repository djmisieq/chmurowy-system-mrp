    ...
    <MainLayout>
      ...
      <div className="bg-white shadow rounded-lg p-6">
        <div className="border-b pb-4 mb-4">
          ...
          <p className="text-gray-500 mt-1">Funkcjonalność zarządzania zamówieniami klientów zostanie dodana wkrótce.</p>
        </div>
        
        <div className="flex justify-center items-center h-64 bg-gray-50 rounded-lg">
          <p className="text-gray-500 text-center px-4">
            Tutaj pojawi się lista zamówień klientów z możliwością ich tworzenia, edycji i śledzenia statusów.
            <br /><br />
